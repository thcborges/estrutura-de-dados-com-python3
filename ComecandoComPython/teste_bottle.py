from ComecandoComPython.bottle import Bottle, run
...
<p>Python é uma linguagem fácil de aprender, você escreve puco e é bem didática. O curso de Python lhe fornecerá a 
